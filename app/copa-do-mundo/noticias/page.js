...
export default function NoticiasCopaPage() {
  const [items, setItems] = useState([]);
  const [loading, setLoading] = useState(true);

  async function loadNoticias() {
    try {
      const res = await fetch(`/api/copa-do-mundo/noticias?t=${Date.now()}`, {
        cache: "no-store",
      });
    ...
    >
      ...
      >
        ...
        {loading ? (
          ...
          >
            Nenhuma notícia da Copa publicada no momento.
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div style={{ padding: 16 }}>
                    ...
                    {slug ? (
                      <Link
                        href={`/copa-do-mundo/noticias/${slug}`}
                        style={{
                          marginTop: 14,
                          display: "inline-flex",
                          alignItems: "center",
