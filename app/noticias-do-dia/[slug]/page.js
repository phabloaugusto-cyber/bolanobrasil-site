    ...
    <main style={styles.page}>
      <div style={styles.container}>
        <div style={styles.top}>
          <Link href="/noticias-do-dia" style={styles.backLink}>
            ← Voltar para Notícias do Dia
          </Link>
        ...
        {loading ? (
          <p style={styles.loading}>Carregando notícia...</p>
        ) : !post ? (
          <p style={styles.loading}>Notícia não encontrada.</p>
        ) : (
          <>
