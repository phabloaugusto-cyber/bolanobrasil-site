    ...
    <main style={styles.container}>
      ...
      >
        <section
          style={{
            ...
            padding: "26px 20px",
            background:
              "linear-gradient(135deg, rgba(19,44,99,0.98) 0%, rgba(10,10,10,0.98) 78%)",
        ...
        >
          ...
          <div
            style={{
              ...
              height: 4,
              background:
                "linear-gradient(90deg, #f4c400 0%, #d6a800 38%, #178a45 100%)",
            }}
          />
      ...
      {featuredAnalise && (
        <section style={{ ...styles.sectionCard, ...styles.sectionAnalysis }}>
          ...
          {(featuredAnalise.image_url || featuredAnalise.imagem) && (
            <img
              src={featuredAnalise.image_url || featuredAnalise.imagem}
              alt={featuredAnalise.title || "Análise"}
      ...
      {featuredHumor && (
        <section style={styles.sectionBlock}>
          ...
          {(featuredHumor.image_url || featuredHumor.imagem) && (
            <img
              src={featuredHumor.image_url || featuredHumor.imagem}
              alt={featuredHumor.title || featuredHumor.titulo || "Humor na Rodada"}
              style={styles.humorImage}
            />
          )}

          <div style={styles.humorBadgeRow}>
            <span style={styles.humorBadge}>Humor na Rodada</span>
            <span style={styles.humorDate}>
              {featuredHumor.date
                ? featuredHumor.date
                : featuredHumor.publishedAt
                ? new Intl.DateTimeFormat("pt-BR", {
                    timeZone: "America/Sao_Paulo",
                    day: "2-digit",
                    month: "2-digit",
                    year: "numeric",
                  }).format(new Date(featuredHumor.publishedAt))
                : ""}
            </span>
          </div>

          <h3 style={styles.humorTitle}>
            {featuredHumor.title || featuredHumor.titulo}
          </h3>
          <p style={styles.humorExcerpt}>
            {featuredHumor.excerpt || featuredHumor.resumo}
          </p>

          <div style={styles.humorFooter}>
            <span style={styles.humorAuthor}>
              {featuredHumor.author || "Redação BolaNoBrasil"}
            </span>
        ...
        <section style={{ ...styles.sectionCard, ...styles.sectionNoticias }}>
          ...
          {(item.image_url || item.imagem) && (
            <img
              ...
              alt={item.title || item.titulo || "Notícia"}
              style={styles.newsHomeImage}
            />
          )}
          ...
          <h3 style={styles.newsHomeTitle}>{item.title || item.titulo}</h3>
          <p style={styles.newsHomeExcerpt}>{item.excerpt || item.resumo}</p>

          <div style={styles.newsHomeFooter}>
            <span style={styles.newsHomeAuthor}>
              {item.author || "Redação BolaNoBrasil"}
            </span>
